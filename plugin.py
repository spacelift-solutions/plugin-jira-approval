...
## Plan Summary
- ✅ **Create:** {changes['create']} resource(s)
- 🔄 **Update:** {changes['update']} resource(s)
- ❌ **Delete:** {changes['delete']} resource(s)
- 🔁 **Replace:** {changes['replace']} resource(s)

[View issue in Jira →]({issue_url})
"""
